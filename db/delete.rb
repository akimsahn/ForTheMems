...
UserFlashcard.create(user: u1, flashcard: f1)
UserFlashcard.create(user: u1, flashcard: f2)
UserFlashcard.create(user: u1, flashcard: f3)
UserFlashcard.create(user: u1, flashcard: f4)
UserFlashcard.create(user: u1, flashcard: f5)
UserFlashcard.create(user: u1, flashcard: f6)
UserFlashcard.create(user: u1, flashcard: f7)

c1 = Collection.create(name: "Test Collection 1", user: u1)
